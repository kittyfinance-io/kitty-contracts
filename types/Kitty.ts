...
export interface KittyInterface extends utils.Interface {
  functions: {
    "INITIAL_LAUNCH_DISTRIBUTION()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "INITIAL_LAUNCH_DISTRIBUTION",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Kitty extends BaseContract {
  ...
  INITIAL_LAUNCH_DISTRIBUTION(overrides?: CallOverrides): Promise<BigNumber>;
