...
export interface CatRewardPoolInterface extends utils.Interface {
  functions: {
...
export interface CatRewardPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CatRewardPoolInterface;
