...
export interface KittyRewardPoolInterface extends utils.Interface {
  functions: {
    ...
    "epochKittyPerSecond(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "epochKittyPerSecond",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface KittyRewardPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KittyRewardPoolInterface;
